...
- Created a route and variant inventory with hash-verified Figma images. Four route defaults and 15 variants are visually reviewed; 16 route defaults and 10 variants remain pending. The manifest and `dart run tool/report_figma_ui_coverage.dart` are the current coverage source.
